package com.example.hr.applicaation.business;
...
import com.example.hr.domain.application.HrApplication;
...
public class StandardHrApplication implements HrApplication {
	...
	public Employee hireEmployee(Employee employee) {
		...
		if (employeeRepository.existsByKimlikNo(kimlik))
			throw new ExistingEmployeeException("Employee alreadt exist", kimlik.getValue());
